 ...
 *                   example: 500
 */
router.get("/product/:item_id", products_1.getProductItem);
/**
 * @swagger
 * /api/product:
 *   get:
 ...
 *
 */
router.get("/product/sex", products_1.getAllProductItemBySex);
/**
 * @swagger
 * /api/product/tag:
 *   get:
 ...
 *
 */
router.get("/product/tag", products_1.getAllProductItemByTag);
/**
 * @swagger
 * /api/product/{item_id}:
 *   delete:
 ...
 *                   example: 500
 */
router.get("/product/:id", products_1.deleteProductItem);
/**
 * @swagger
 * /api/search:
 *   get:
 ...
 */
router.get("/search", products_1.getAllProductItemByName);
